        ...
        children: [
          ...
          ConcertInfo(
            ...
            venue:
                ...
                '【磐田】\n'
                'dolce倉庫\n'
                '〒437-1203 静岡県磐田市福田 6085-15\n'
                '(JR 磐田駅より車で 15 分 / バスで 20 分)\n'
                '【東京】\n'
                '下北沢アレイ'
                '〒155-0031 東京都世田谷区北沢 2 丁目 24-8 下北沢アレイ 3 階\n'
                '(下北沢駅（小田急線・井の頭線）より徒歩 5 分)\n'
                '【長野】\n'
                '〒380-0841 長野県長野市大門町511\n'
                '(JR長野駅より徒歩15分)',
            address: '',
            flyerImagePaths: ['assets/flyers/20260812a.png', 'assets/flyers/20260812b.png'],
            programs: [
              ProgramItem(composer: 'ショパン', pieces: ['バラード第 1 番ト短調 作品 23']),
              ProgramItem(composer: 'ベートーヴェン', pieces: ['ピアノソナタ第 7 番 イ⻑調 作品 10-3']),
              ProgramItem(composer: 'ブルグミュラー', pieces: ['25 の練習曲より「すなおな⼼」「アラベスク」「パストラル(牧歌)」']),
              ProgramItem(composer: 'ブラームス', pieces: ['２つのラプソディより第 1 番 ロ短調 作品 79-1']),
              ProgramItem(composer: 'リスト', pieces: ['村の居酒屋での踊り(メフィストワルツ第 1 番) S.514']),
              ProgramItem(composer: 'ドビュッシー', pieces: ['喜びの島']),
            ],
            ticketPrice:
                '一般 2,200円 U23 1,200円 ⾼校⽣以下無料\n'
                '未就学児童⼊場可\n'
                '車椅子席あり',
            ticketInfo:
                '【全公演共通】\n'
                ...
                '美鈴楽器本店',
            ticketOptions: [
              '【全公演共通】\nチケットぴあ (Pコード：330403 ※磐田・東京・長野)\nhttps://t.pia.jp/pia/artist/artists.do?artistsCd=O7040029'
                  '\nすみやグッディ 本店（呉服町）\nTEL：054-253-6222【11:00～19:00／水曜日定休】',
              '【浜松】\nアクトシティ浜松チケットセンター\n（店頭販売のみ／10：00〜19：00）'
                  '\nHCF オンラインショップ\nhttps://www.hcf.or.jp/shop/index.php',
              '【磐田】\n磐田市情報館 ららぽーと磐田内\nTEL：0538-38-2974【10:00～20:00／土曜のみ21:00まで】'
                  '\n兵頭楽器店 掛川店\nTEL：0537-23-0245【11:00~19:00／月曜定休、日曜日のみ18:00まで】'
                  '\n兵頭楽器店 袋井ミュージックセンター\nTEL：0538-37-0354【14:30~19:00/日曜定休】',
              '【長野】\nヒオキ楽器本店\nTEL：026-291-6438【10:00~19:00】'
                  '\n美鈴楽器本店\nTEL：026-223-6000【10:00~19:00／日曜日のみ18:00まで】',
            ],
